...
# 4.1. Pregatirea si standardizarea datelor
...
# 4.3. Valorile proprii si selectarea componentelor principale
...
# 4.5. Incarcarile factorilor (Factor Loadings)
...
# 4.7. Calitatea Reprezentarii Observatiilor
