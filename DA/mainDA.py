...
try:
    ...
    # 5.3 Puterea de Discriminare a Variabilelor
    ...
    # 5.4 Matricea de Confuzie si Performanta Modelului
    ...
    # 5.5 Separarea Grupurilor si Centrii Lor
